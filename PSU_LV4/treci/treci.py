...
def non_func(x):
    y = 1.6345 -0.6235*np.cos(0.6067*x) -1.3501*np.sin(0.6067*x) - 1.622 * np.cos(0.6067*x) - 0.9443*np.sin(2*x*0.6067)
    return y
...
for degree in degrees:
    ...
    MSE_test.append(mean_squared_error(y_test, ytest_p))
